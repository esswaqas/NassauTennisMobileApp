...
//console.log("jsdfsdsdf sdfjklsdfjklsdf sdf   = ======  ="+JSON.stringify(addtoGrid))

            var url = 'CustomerCampRegistration/ProcessPaymentCampRegistration?isCampRegistration=true';
                ...
                .then(responseJson => {
                   // alert(JSON.stringify(responseJson))
                    ...
                    if (responseJson.isSuccess == true) {
                        ...
                        AsyncStorage.removeItem('CampGrid');
